...
for j = 1:length(k_off_vec)
    ...
    title(['Mean: Predicte vs. Actual (' num2str(K) 'States)'], 'fontsize',10);
    xlabel('Time Steps');
    ...
    title(['Variance: Predicte vs. Actual (' num2str(K) ' States)'],  'fontsize',10);
    xlabel('Time Steps');
